 ...
 * @author kienb
 */
public class loadLapTop extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String amount = request.getParameter("exitsLaptop");
        int iamount = Integer.parseInt(amount);
        DaoProduct dao = new DaoProduct();
        List<product> list = dao.getNext4LapTopProduct(iamount);
        PrintWriter out = response.getWriter();
        for (product o : list) {
            out.println("<div class=\"productLapTop col-12 col-md-6 col-lg-3\">\r\n"
            		+ "                                <div class=\"card\">\r\n"
