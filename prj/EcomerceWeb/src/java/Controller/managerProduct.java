...
public class managerProduct extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<product> list = dpro.getListProductByAccountid(a.getId(),indexPage);
        List<Category> listC = dcate.listAllCategory();
        int allProductBySellID = dpro.countAllProductByAccountid(a.getId());
