...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/pagger.css"/>
                ...
                <div class="container" style="margin-top:100px">
                            ...
                            <section>
                                ...
                                <section>
                                    ...
                                    <c:forEach items="${listCC}" var="o">
                                        <p class="mb-3"><a onclick="load(${o.cate_id})" class="card-link-secondary">${o.cate_name}</a></p>
                                        </c:forEach>
                                </div>
                                    ...
                                    <div class="col-md-4 mb-5">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="text-center pt-4">
                                                ...
                                                <p><span class="mr-1"><strong>${o.displayPrice()}</strong></span></p>
                    ...
                    <jsp:include page="Footer.jsp"></jsp:include>
                        ...
                        <script type="text/javascript">
                                            render("top_pagger",${requestScope.tag},${requestScope.endPage}, 5);
                                            $('#multi').mdbRange({
                                                single: {
                                                    active: true,
                                                    multi: {
                                            ...
                                            function searchByName(param) {
                                                ...
                                                $.ajax({
                                                    url: "/EcomerceWeb/searchAjaxShop",
                                                    type: "get", //send it through get method
                                                    data: {
                                                        txt: txtSearch
                                                    },
                                            ...
                                            function searchByPriceMinToMax() {
                                                ...
                                                $.ajax({
                                                    url: "/EcomerceWeb/searchAjaxPriceMinToMax",
                                                    type: "get", //send it through get method
                                                    data: {
                                                        priceMin: numMin,
                                                        priceMax: numMax
                                            ...
                                            function searchByPriceUnder100() {
                                                $.ajax({
                                                    url: "/EcomerceWeb/searchAjaxPriceUnder100Shop",
                                                    type: "get", //send it through get method
                                                    data: {
                                            ...
                                            function searchByPrice100To200() {
                                                $.ajax({
                                                    url: "/EcomerceWeb/searchAjaxPrice100To200Shop",
                                                    type: "get", //send it through get method
                                                    data: {
                                            ...
                                            function searchByPriceAbove200() {
                                                $.ajax({
                                                    url: "/EcomerceWeb/searchAjaxPriceAbove200Shop",
                                                    type: "get", //send it through get method
                                                    data: {
