...
<nav class="navbar navbar-expand-md navbar-dark bg-dark" style="position: fixed; top: 0; width:100%;  z-index: 100000;">
    <div class="container">
        <a class="navbar-brand" href="HomeControl">Ecomerce Web</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <c:if test="${sessionScope.acc != null}">
                    ...
                    <c:if test="${sessionScope.acc.roleID != 2}">
                        <li class="nav-item">
                            <a class="nav-link" href="managerProduct">Product Manager</a>
                        </li>
                    </c:if>
                </c:if>
                <c:if test="${sessionScope.acc == null}">
            ...
            <form action="search" method="post" class="form-inline my-2 my-lg-0">
                ...
                <a class="btn btn-success btn-sm ml-3" href="managerCart">
                    ...
                    <b><span id="amountCart" class="badge badge-light" style="color:black; font-size: 12px;">${sessionScope.NumberOfCart}</span></b>                 
                </a>
            </form>
        </div>
    </div>
