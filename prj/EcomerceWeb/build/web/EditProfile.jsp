    ...
    <body>
        <jsp:include page="Menu.jsp"></jsp:include>
            <div id="logreg-forms">
                ...
                <input name="fullname" type="text" id="fullname" class="form-control" value="${sessionScope.acc.fullname }"  autofocus="">
                <label for="address">Address</label>
                <input name="address" type="text" id="address" class="form-control" value="${sessionScope.acc.address }"  autofocus="">
                <label for="dob">Birthday</label>
                <input name="dob" type="date" id="dob" class="form-control" value="${sessionScope.acc.dob }"  autofocus="">
